...
- managing worksheets - add, remove, resize, change the title, formatting, duplicate, copy to another sheet
- managing docs - create a new doc, delete doc, basic sharing/permissions
...
const serviceAccountAuth = new JWT({
  ...
  // see the "Authentication" section in docs for more info
...
Row methods support explicit TypeScript types for the data
...
This module makes trade-offs for interface simplicity.
