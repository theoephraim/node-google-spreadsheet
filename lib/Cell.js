...
function Cell( spreadsheet, ss_key, worksheet_id, data ){
  if(!(this instanceof Cell))
    return new Cell( spreadsheet, ss_key, worksheet_id, data )
  ...
  this.save = function(cb) {
    ...
    var edit_id = 'https://spreadsheets.google.com/feeds/cells/'+ss_key+'/'+worksheet_id+'/private/full/R'+this.row+'C'+this.col;
    var data_xml =
    [
